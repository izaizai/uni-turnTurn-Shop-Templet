...
<script>
	import trendsList from '@/zaiui/components/list/trends-list';
	import hotTopicList from '@/zaiui/components/list/hot-topic-list';
	import recommendScrollList from '@/zaiui/components/list/recommend-scroll-list';
	import topicGridList from '@/zaiui/components/list/topic-grid-list';
	import topicCardList from '@/zaiui/components/list/topic-card-list';
	
	//======================================================================
	import _find_data from '@/zaiui/data/find.js';	//虚拟数据
